...
**Version:** 1.4
**Status:** Draft（KNET-CC-019 §3.1 取键位置对齐**已会签定稿（KNET-CC-019，2026-08-29 节点 PM 会签通过 + 协议 PM 合并 master 1dcf495 联合关闭）**；§7.4 独立已会签定稿（KNET-CC-011））
**Date:** 2026-08-29
...
> 已会签定稿（KNET-CC-019 §3.1 取键位置对齐，2026-08-29 节点 PM 会签通过 + 协议 PM 合并 master 1dcf495 联合关闭）；文件整体 Draft，§7.4 独立已会签定稿（KNET-CC-011）。
